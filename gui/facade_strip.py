...
class FacadeStrip(QFrame):
    ...
    def dragEnterEvent(self, e: QMouseEvent):
        ...
        can_drop_group = self.mode == "structured" and mime_data.hasFormat("application/x-ibg-group")
    ...
    def dropEvent(self, e: QMouseEvent) -> None:
        ...
        if mime_data.hasFormat("application/x-ibg-module"):
            ...
            group = self._find_or_create_sandbox_group() if self.mode == "sandbox" else GroupWidget(parent=self)
            ...
            group_insert_pos = group.layout().count() if self.mode == "sandbox" else 0
        ...
        elif self.mode == "structured" and mime_data.hasFormat("application/x-ibg-group"):
